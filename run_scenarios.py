...
async def run_policy_comparison():
    ...
    policies = ["tax_increase", "environmental_regulation", "social_inequality"]
...
async def run_crisis_scenarios():
    ...
    crises = ["energy_crisis", "pandemic", "infrastructure_failure"]
...
async def run_innovation_scenarios():
    ...
    innovations = ["autonomous_transport", "smart_grid"]
