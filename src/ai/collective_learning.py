...
class CollectiveLearningSystem:
    ...
    def get_shared_experiences(self, agent_type: str, limit: int = 100) -> List[Experience]:
        ...
        relevant_experiences = [
            exp for exp in self.collective_memory
            if exp.agent_id.startswith(agent_type)
        ]
        return relevant_experiences[-limit:]
    
    def share_knowledge(self, agent_id: str, strategy: str, success_rate: float, 
    ...
    def _is_knowledge_relevant(self, knowledge: SharedKnowledge, agent_type: str, 
    ...
    def get_learning_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': (
                ...
                (self.learning_stats['successful_adaptations'] + 
                 self.learning_stats['failed_adaptations'] + 1e-8)
            )
        }
...
class AgentLearningModule:
    ...
    def encode_state(self, agent_state: Dict[str, Any], 
                    environment_context: Dict[str, Any]) -> np.ndarray:
    ...
    def _select_exploitative_action(self, state: np.ndarray, 
