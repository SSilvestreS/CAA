...
class BusinessAgent(BaseAgent):
    ...
    async def _make_pricing_decision(self, situation: Dict[str, Any], 
                                   competitor_actions: List[Dict]) -> Dict[str, Any]:
    ...
    async def _dynamic_pricing(self, situation: Dict[str, Any], 
                             competitor_actions: List[Dict]) -> float:
    ...
    async def _make_investment_decision(self, situation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'recommended_investment': max(investment_opportunities, 
                                        key=lambda x: x['expected_return']) 
                                        if investment_opportunities else None
        }
        ...
        if available >= quantity and max_price >= self.current_price:
            ...
            if available < quantity:
                ...
                return {
                    ...
                    'minimum_price': self.current_price
                }
