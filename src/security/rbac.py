...
class RBACService:
    ...
    def has_resource_permission(self, user_id: str, resource: Resource, 
    ...
    def update_role(self, name: str, description: str = None,
                   ...
                   resources: Set[Resource] = None) -> bool:
...
class AccessControl:
    ...
    def check_access(self, user_id: str, resource: Resource, 
                    action: Permission, context: Dict = None) -> bool:
