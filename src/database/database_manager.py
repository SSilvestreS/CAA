...
class DatabaseManager:
    ...
    def log_event(self, simulation_id: int, event_type: str, description: str, 
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?)
            """, (simulation_id, event_type, agent_id, description, 
                  json.dumps(data) if data else None))
            conn.commit()
    
    def save_metric(self, simulation_id: int, metric_name: str, value: float, 
    ...
    def log_interaction(self, simulation_id: int, agent_from: str, agent_to: str, 
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute("""
                ...
                VALUES (?, ?, ?, ?, ?, ?)
            """, (simulation_id, agent_from, agent_to, interaction_type,
                  json.dumps(data) if data else None, result))
            conn.commit()
